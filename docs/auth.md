# auth
<code>balena.auth</code> : <code>object</code>
...
## authenticate
<code>balena.auth.authenticate(credentials)</code> ⇒ <code>Promise</code>
...
## getActorId
<code>balena.auth.getActorId()</code> ⇒ <code>Promise</code>
...
## getToken
<code>balena.auth.getToken()</code> ⇒ <code>Promise</code>
...
## getUserInfo
<code>balena.auth.getUserInfo()</code> ⇒ <code>Promise</code>
...
## isLoggedIn
<code>balena.auth.isLoggedIn()</code> ⇒ <code>Promise</code>
...
## login
<code>balena.auth.login(credentials)</code> ⇒ <code>Promise</code>
...
## loginWithToken
<code>balena.auth.loginWithToken(authToken)</code> ⇒ <code>Promise</code>
...
## logout
<code>balena.auth.logout()</code> ⇒ <code>Promise</code>
...
## register
<code>balena.auth.register(credentials)</code> ⇒ <code>Promise</code>
...
<code>balena.auth.requestVerificationEmail()</code> ⇒ <code>Promise</code>
...
## verifyEmail
<code>balena.auth.verifyEmail(verificationPayload)</code> ⇒ <code>Promise</code>
...
## whoami
<code>balena.auth.whoami()</code> ⇒ <code>Promise</code>
...
## twoFactor
<code>balena.auth.twoFactor</code> : <code>object</code>
...
### challenge
<code>balena.auth.twoFactor.challenge(code)</code> ⇒ <code>Promise</code>
...
### disable
<code>balena.auth.twoFactor.disable(password)</code> ⇒ <code>Promise</code>
...
### enable
<code>balena.auth.twoFactor.enable(code)</code> ⇒ <code>Promise</code>
...
### getSetupKey
<code>balena.auth.twoFactor.getSetupKey()</code> ⇒ <code>Promise</code>
...
### isEnabled
<code>balena.auth.twoFactor.isEnabled()</code> ⇒ <code>Promise</code>
...
### isPassed
<code>balena.auth.twoFactor.isPassed()</code> ⇒ <code>Promise</code>
...
### verify
<code>balena.auth.twoFactor.verify(code)</code> ⇒ <code>Promise</code>
