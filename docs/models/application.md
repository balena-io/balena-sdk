# application
<code>balena.models.application</code> : <code>object</code>
...
## create
<code>balena.models.application.create(options)</code> ⇒ <code>Promise</code>
...
## disableDeviceUrls
<code>balena.models.application.disableDeviceUrls(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## enableDeviceUrls
<code>balena.models.application.enableDeviceUrls(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.generateProvisioningKey(generateProvisioningKeyParams)</code> ⇒ <code>Promise</code>
...
## get
<code>balena.models.application.get(slugOrUuidOrId, [options], [context])</code> ⇒ <code>Promise</code>
...
## getAll
<code>balena.models.application.getAll([options], [context])</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.getAllByOrganization(orgHandleOrId, [options])</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.getAllDirectlyAccessible([options])</code> ⇒ <code>Promise</code>
...
## getAppByName
<code>balena.models.application.getAppByName(appName, [options], [context])</code> ⇒ <code>Promise</code>
...
## getDashboardUrl
<code>balena.models.application.getDashboardUrl(id)</code> ⇒ <code>String</code>
...
<code>balena.models.application.getDirectlyAccessible(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.getTargetReleaseHash(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.getWithDeviceServiceDetails(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## grantSupportAccess
<code>balena.models.application.grantSupportAccess(slugOrUuidOrId, expiryTimestamp)</code> ⇒ <code>Promise</code>
...
## has
<code>balena.models.application.has(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## hasAny
<code>balena.models.application.hasAny()</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.isTrackingLatestRelease(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## pinToRelease
<code>balena.models.application.pinToRelease(slugOrUuidOrId, fullReleaseHash)</code> ⇒ <code>Promise</code>
...
## purge
<code>balena.models.application.purge(appId)</code> ⇒ <code>Promise</code>
...
## reboot
<code>balena.models.application.reboot(appId, [options])</code> ⇒ <code>Promise</code>
...
## remove
<code>balena.models.application.remove(slugOrUuidOrIdOrIds)</code> ⇒ <code>Promise</code>
...
## rename
<code>balena.models.application.rename(slugOrUuidOrId, newName)</code> ⇒ <code>Promise</code>
...
## restart
<code>balena.models.application.restart(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## revokeSupportAccess
<code>balena.models.application.revokeSupportAccess(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## shutdown
<code>balena.models.application.shutdown(appId, [options])</code> ⇒ <code>Promise</code>
...
## trackLatestRelease
<code>balena.models.application.trackLatestRelease(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.application.willTrackNewReleases(slugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## buildVar
<code>balena.models.application.buildVar</code> : <code>object</code>
...
### get
<code>balena.models.application.buildVar.get(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.application.buildVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.application.buildVar.remove(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.application.buildVar.set(slugOrUuidOrId, key, value)</code> ⇒ <code>Promise</code>
...
## configVar
<code>balena.models.application.configVar</code> : <code>object</code>
...
### get
<code>balena.models.application.configVar.get(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.application.configVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.application.configVar.remove(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.application.configVar.set(slugOrUuidOrId, key, value)</code> ⇒ <code>Promise</code>
...
## envVar
<code>balena.models.application.envVar</code> : <code>object</code>
...
### get
<code>balena.models.application.envVar.get(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.application.envVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.application.envVar.remove(slugOrUuidOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.application.envVar.set(slugOrUuidOrId, key, value)</code> ⇒ <code>Promise</code>
...
## invite
<code>balena.models.application.invite</code> : <code>object</code>
...
### accept
<code>balena.models.application.invite.accept(invitationToken)</code> ⇒ <code>Promise</code>
...
### create
<code>balena.models.application.invite.create(slugOrUuidOrId, options, [message])</code> ⇒ <code>Promise</code>
...
### getAll
<code>balena.models.application.invite.getAll([options])</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.application.invite.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### revoke
<code>balena.models.application.invite.revoke(id)</code> ⇒ <code>Promise</code>
...
## membership
<code>balena.models.application.membership</code> : <code>object</code>
...
### changeRole
<code>balena.models.application.membership.changeRole(idOrUniqueKey, roleName)</code> ⇒ <code>Promise</code>
...
### create
<code>balena.models.application.membership.create(options)</code> ⇒ <code>Promise</code>
...
### get
<code>balena.models.application.membership.get(membershipId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.application.membership.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByUser
<code>balena.models.application.membership.getAllByUser(usernameOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.application.membership.remove(idOrUniqueKey)</code> ⇒ <code>Promise</code>
...
## tags
<code>balena.models.application.tags</code> : <code>object</code>
...
### getAllByApplication
<code>balena.models.application.tags.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.application.tags.remove(slugOrUuidOrId, tagKey)</code> ⇒ <code>Promise</code>
