# device
<code>balena.models.device</code> : <code>object</code>
...
## deactivate
<code>balena.models.device.deactivate(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## disableDeviceUrl
<code>balena.models.device.disableDeviceUrl(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## disableLocalMode
<code>balena.models.device.disableLocalMode(uuidOrId)</code> ⇒ <code>Promise</code>
...
## disableLockOverride
<code>balena.models.device.disableLockOverride(uuidOrId)</code> ⇒ <code>Promise</code>
...
## enableDeviceUrl
<code>balena.models.device.enableDeviceUrl(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## enableLocalMode
<code>balena.models.device.enableLocalMode(uuidOrId)</code> ⇒ <code>Promise</code>
...
## enableLockOverride
<code>balena.models.device.enableLockOverride(uuidOrId)</code> ⇒ <code>Promise</code>
...
## generateDeviceKey
<code>balena.models.device.generateDeviceKey(uuidOrId, [keyName], [keyDescription])</code> ⇒ <code>Promise</code>
...
## generateUniqueKey
<code>balena.models.device.generateUniqueKey()</code> ⇒ <code>String</code>
...
## get
<code>balena.models.device.get(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## getAllByApplication
<code>balena.models.device.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.getAllByOrganization(handleOrId, [options])</code> ⇒ <code>Promise</code>
...
## getApplicationName
<code>balena.models.device.getApplicationName(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getByName
<code>balena.models.device.getByName(name)</code> ⇒ <code>Promise</code>
...
## getDashboardUrl
<code>balena.models.device.getDashboardUrl(uuid)</code> ⇒ <code>String</code>
...
## getDeviceUrl
<code>balena.models.device.getDeviceUrl(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getLocalIPAddresses
<code>balena.models.device.getLocalIPAddresses(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getLocalModeSupport
<code>balena.models.device.getLocalModeSupport(device)</code> ⇒ <code>Object</code>
...
## getMACAddresses
<code>balena.models.device.getMACAddresses(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getMetrics
<code>balena.models.device.getMetrics(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getName
<code>balena.models.device.getName(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getOsVersion
<code>balena.models.device.getOsVersion(device)</code> ⇒ <code>String</code>
...
## getProgress
<code>balena.models.device.getProgress(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getStatus
<code>balena.models.device.getStatus(uuidOrId)</code> ⇒ <code>Promise</code>
...
## getSupervisorState
<code>balena.models.device.getSupervisorState(uuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.getSupervisorTargetState(uuidOrId, version)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.getSupervisorTargetStateForApp(uuidOrId, release)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.getTargetReleaseHash(uuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.getWithServiceDetails(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## grantSupportAccess
<code>balena.models.device.grantSupportAccess(uuidOrIdOrArray, expiryTimestamp)</code> ⇒ <code>Promise</code>
...
## has
<code>balena.models.device.has(uuidOrId)</code> ⇒ <code>Promise</code>
...
## hasDeviceUrl
<code>balena.models.device.hasDeviceUrl(uuidOrId)</code> ⇒ <code>Promise</code>
...
## hasLockOverride
<code>balena.models.device.hasLockOverride(uuidOrId)</code> ⇒ <code>Promise</code>
...
## identify
<code>balena.models.device.identify(uuidOrId)</code> ⇒ <code>Promise</code>
...
## isInLocalMode
<code>balena.models.device.isInLocalMode(uuidOrId)</code> ⇒ <code>Promise</code>
...
## isOnline
<code>balena.models.device.isOnline(uuidOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.isTrackingApplicationRelease(uuidOrId)</code> ⇒ <code>Promise</code>
...
## move
<code>balena.models.device.move(uuidOrIdOrArray, applicationSlugOrUuidOrId)</code> ⇒ <code>Promise</code>
...
## ping
<code>balena.models.device.ping(uuidOrId)</code> ⇒ <code>Promise</code>
...
## pinToOsRelease
<code>balena.models.device.pinToOsRelease(uuidOrIdOrArray, osVersionOrId)</code> ⇒ <code>Promise</code>
...
## pinToRelease
<code>balena.models.device.pinToRelease(uuidOrIdOrArray, fullReleaseHashOrId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.pinToSupervisorRelease(uuidOrIdOrArray, supervisorVersionOrId)</code> ⇒ <code>Promise</code>
...
## purge
<code>balena.models.device.purge(uuidOrId)</code> ⇒ <code>Promise</code>
...
## reboot
<code>balena.models.device.reboot(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## register
<code>balena.models.device.register(applicationSlugOrUuidOrId, uuid, [deviceTypeSlug])</code> ⇒ <code>Promise</code>
...
## remove
<code>balena.models.device.remove(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## rename
<code>balena.models.device.rename(uuidOrId, newName)</code> ⇒ <code>Promise</code>
...
## restartApplication
<code>balena.models.device.restartApplication(uuidOrId)</code> ⇒ <code>Promise</code>
...
## restartService
<code>balena.models.device.restartService(uuidOrId, imageId)</code> ⇒ <code>Promise</code>
...
## revokeSupportAccess
<code>balena.models.device.revokeSupportAccess(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## setCustomLocation
<code>balena.models.device.setCustomLocation(uuidOrIdOrArray, location)</code> ⇒ <code>Promise</code>
...
## setNote
<code>balena.models.device.setNote(uuidOrIdOrArray, note)</code> ⇒ <code>Promise</code>
...
## shutdown
<code>balena.models.device.shutdown(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## startOsUpdate
<code>balena.models.device.startOsUpdate(uuidOrUuids, targetOsVersion, [options])</code> ⇒ <code>Promise</code>
...
## startService
<code>balena.models.device.startService(uuidOrId, imageId)</code> ⇒ <code>Promise</code>
...
## stopService
<code>balena.models.device.stopService(uuidOrId, imageId)</code> ⇒ <code>Promise</code>
...
<code>balena.models.device.trackApplicationRelease(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## unsetCustomLocation
<code>balena.models.device.unsetCustomLocation(uuidOrIdOrArray)</code> ⇒ <code>Promise</code>
...
## update
<code>balena.models.device.update(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## configVar
<code>balena.models.device.configVar</code> : <code>object</code>
...
### get
<code>balena.models.device.configVar.get(uuidOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.device.configVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByDevice
<code>balena.models.device.configVar.getAllByDevice(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.device.configVar.remove(uuidOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.device.configVar.set(uuidOrId, key, value)</code> ⇒ <code>Promise</code>
...
## envVar
<code>balena.models.device.envVar</code> : <code>object</code>
...
### get
<code>balena.models.device.envVar.get(uuidOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.device.envVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByDevice
<code>balena.models.device.envVar.getAllByDevice(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.device.envVar.remove(uuidOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.device.envVar.set(uuidOrId, key, value)</code> ⇒ <code>Promise</code>
...
## history
<code>balena.models.device.history</code> : <code>object</code>
...
### getAllByApplication
<code>balena.models.device.history.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByDevice
<code>balena.models.device.history.getAllByDevice(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## serviceVar
<code>balena.models.device.serviceVar</code> : <code>object</code>
...
### get
<code>balena.models.device.serviceVar.get(uuidOrId, serviceNameOrId, key)</code> ⇒ <code>Promise</code>
...
### getAllByApplication
<code>balena.models.device.serviceVar.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByDevice
<code>balena.models.device.serviceVar.getAllByDevice(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.device.serviceVar.remove(uuidOrId, serviceNameOrId, key)</code> ⇒ <code>Promise</code>
...
### set
<code>balena.models.device.serviceVar.set(uuidOrId, serviceNameOrId, key, value)</code> ⇒ <code>Promise</code>
...
## tags
<code>balena.models.device.tags</code> : <code>object</code>
...
### getAllByApplication
<code>balena.models.device.tags.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByDevice
<code>balena.models.device.tags.getAllByDevice(uuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.device.tags.remove(uuidOrId, tagKey)</code> ⇒ <code>Promise</code>
