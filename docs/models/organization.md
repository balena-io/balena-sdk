# organization
<code>balena.models.organization</code> : <code>object</code>
...
## create
<code>balena.models.organization.create(options)</code> ⇒ <code>Promise</code>
...
## get
<code>balena.models.organization.get(handleOrId, [options])</code> ⇒ <code>Promise</code>
...
## getAll
<code>balena.models.organization.getAll([options])</code> ⇒ <code>Promise</code>
...
## remove
<code>balena.models.organization.remove(handleOrId)</code> ⇒ <code>Promise</code>
...
## invite
<code>balena.models.organization.invite</code> : <code>object</code>
...
### accept
<code>balena.models.organization.invite.accept(invitationToken)</code> ⇒ <code>Promise</code>
...
### create
<code>balena.models.organization.invite.create(handleOrId, options, [message])</code> ⇒ <code>Promise</code>
...
### getAll
<code>balena.models.organization.invite.getAll([options])</code> ⇒ <code>Promise</code>
...
<code>balena.models.organization.invite.getAllByOrganization(handleOrId, [options])</code> ⇒ <code>Promise</code>
...
### revoke
<code>balena.models.organization.invite.revoke(id)</code> ⇒ <code>Promise</code>
...
## membership
<code>balena.models.organization.membership</code> : <code>object</code>
...
### changeRole
<code>balena.models.organization.membership.changeRole(idOrUniqueKey, roleName)</code> ⇒ <code>Promise</code>
...
### get
<code>balena.models.organization.membership.get(membershipId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByOrganization
<code>balena.models.organization.membership.getAllByOrganization(handleOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByUser
<code>balena.models.organization.membership.getAllByUser(usernameOrId, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.organization.membership.remove(id)</code> ⇒ <code>Promise</code>
