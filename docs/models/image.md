# image
<code>balena.models.image</code> : <code>object</code>
...
## get
<code>balena.models.image.get(id, [options])</code> ⇒ <code>Promise</code>
...
## getLogs
<code>balena.models.image.getLogs(id)</code> ⇒ <code>Promise</code>
