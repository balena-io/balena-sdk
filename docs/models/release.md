# release
<code>balena.models.release</code> : <code>object</code>
...
## createFromUrl
<code>balena.models.release.createFromUrl(slugOrUuidOrId, urlDeployOptions)</code> ⇒ <code>Promise</code>
...
## finalize
<code>balena.models.release.finalize(commitOrIdOrRawVersion)</code> ⇒ <code>Promise</code>
...
## get
<code>balena.models.release.get(commitOrIdOrRawVersion, [options])</code> ⇒ <code>Promise</code>
...
## getAllByApplication
<code>balena.models.release.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
<code>balena.models.release.getLatestByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
## getWithImageDetails
<code>balena.models.release.getWithImageDetails(commitOrIdOrRawVersion, [options])</code> ⇒ <code>Promise</code>
...
## setIsInvalidated
<code>balena.models.release.setIsInvalidated(commitOrIdOrRawVersion, isInvalidated)</code> ⇒ <code>Promise</code>
...
## setKnownIssueList
<code>balena.models.release.setKnownIssueList(commitOrIdOrRawVersion, knownIssueListOrNull)</code> ⇒ <code>Promise</code>
...
## setNote
<code>balena.models.release.setNote(commitOrIdOrRawVersion, noteOrNull)</code> ⇒ <code>Promise</code>
...
## asset
<code>balena.models.release.asset</code> : <code>object</code>
...
### download
<code>balena.models.release.asset.download(id)</code> ⇒ <code>Promise</code>
...
### get
<code>balena.models.release.asset.get(id, [options])</code> ⇒ <code>Promise</code>
...
### getAllByRelease
<code>balena.models.release.asset.getAllByRelease(commitOrIdOrRawVersion, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.release.asset.remove(id)</code> ⇒ <code>Promise</code>
...
### upload
<code>balena.models.release.asset.upload(uploadParams, [options])</code> ⇒ <code>Promise</code>
...
## tags
<code>balena.models.release.tags</code> : <code>object</code>
...
### getAllByApplication
<code>balena.models.release.tags.getAllByApplication(slugOrUuidOrId, [options])</code> ⇒ <code>Promise</code>
...
### getAllByRelease
<code>balena.models.release.tags.getAllByRelease(commitOrIdOrRawVersion, [options])</code> ⇒ <code>Promise</code>
...
### remove
<code>balena.models.release.tags.remove(commitOrIdOrRawVersion, tagKey)</code> ⇒ <code>Promise</code>
