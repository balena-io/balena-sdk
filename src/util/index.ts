...
import type { Expand, ODataOptions, Resource, ResourceExpand, AnyResourceObject, ODataOptionsWithoutCount } from 'pinejs-client-core';
...
export type MergedInnerOptions<
	...
	E extends Readonly<NonNullable<ExtraOptions>>,
...
export type MergedOptions<
	D extends Readonly<ODataOptions>,
	E extends Readonly<ExtraOptions>,
> = E extends undefined
	? Readonly<D>
	: Omit<D, ExtraKeys> & Pick<MergedInnerOptions<D, NonNullable<E>>, ExtraKeys>;
...
export function mergePineOptions<
	D extends Readonly<ODataOptions>,
	E extends Readonly<ExtraOptions> = undefined,
