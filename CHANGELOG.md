...
* Add support for pine.upsert() [Thodoris Greasidis]
* Typings: Add `is_public` to the application model [Thodoris Greasidis]
* Tests: Update child app tests to work after the public app changes [Thodoris Greasidis]
* Drop owns__organization from the model [Thodoris Greasidis]
* Add support for the organizations model [Thodoris Greasidis]
* **DROP-ME**: Use the /resin endpoint [Thodoris Greasidis]
