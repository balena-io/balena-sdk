...
* Update actions/setup-node action to v7 [balena-renovate[bot]]

## 23.2.14 - 2026-07-28

* Update dependency rindle to v2 [balena-renovate[bot]]
...
* Update dependency webpack-cli to v7 [balena-renovate[bot]]

## 23.2.11 - 2026-07-01

* Update tests after API's switch from is_online to is_connected_to_vpn [Thodoris Greasidis]
...
<details>
<summary> Update balena-auth to deduplicate balena-errors [Thodoris Greasidis] </summary>

> ### balena-auth-6.1.1 - 2026-06-10
> 
> * Update devDependencies [Thodoris Greasidis]
> 
> <details>
> <summary> Update balena-settings-storage from 8.1.0 to 9.0.0 [Thodoris Greasidis] </summary>
> 
>> #### balena-settings-storage-9.0.0 - 2026-06-10
>> 
>> * Update balena-errors to v5.0.0 [Thodoris Greasidis]
>> * Move the sources from lib to src [Thodoris Greasidis]
>> * Drop appveyor config [Thodoris Greasidis]
>> * Target es2019 runtimes [Thodoris Greasidis]
>> * Drop support for node < 18 [Thodoris Greasidis]
>> 
>> #### balena-settings-storage-8.2.0 - 2026-03-24
>> 
>> * Export error types for users to be able to use `instanceof` with [Pagan Gazzard]
>> 
>> #### balena-settings-storage-8.1.1 - 2026-03-12
>> 
>> * Update jsdoc-to-markdown to 9.x [Pagan Gazzard]
...
* Update GitHub Actions to 48b55a0 [balena-renovate[bot]]

## 23.2.2 - 2026-06-03

* Generate documentation as separate pages for the docs [Matthew Yarmolinsky]

## 23.2.1 - 2026-06-02

* Fix failing tests per recent API changes [Matthew Yarmolinsky]
* Remove deprecation policy in favor of moving it to the product docs [Matthew Yarmolinsky]

## 23.2.0 - 2026-04-23

* Remove unnecessary type assertions [Andrea Rosci]
* Add team membership model [Andrea Rosci]

## 23.1.18 - 2026-04-21

* devices: Add downgrade checks to startOsUpdate & pinToOsRelease for rolling to ESR OS updates [Thodoris Greasidis]

## 23.1.17 - 2026-03-31

* Update TypeScript to 6.0.2 [Thodoris Greasidis]

## 23.1.16 - 2026-03-24

* Update actions/setup-node digest to 53b8394 [balena-renovate[bot]]

## 23.1.15 - 2026-03-24

* Drop chai-samsam from the devDependencies [Thodoris Greasidis]

## 23.1.14 - 2026-03-23

* Run `npm run docs` [Matthew Yarmolinsky]
* Update docs script to alphabetize content [Matthew Yarmolinsky]

## 23.1.13 - 2026-03-20

* os.download: Improve error thrown if version is not found [Matthew Yarmolinsky]

## 23.1.12 - 2026-03-19

* device.pinToOsRelease: Prevent pinning to different variant of the current OS version [Thodoris Greasidis]

## 23.1.11 - 2026-03-16

* Update dependency dotenv to v17 [balena-renovate[bot]]

## 23.1.10 - 2026-03-16

* Update dependency domain-browser to v5 [balena-renovate[bot]]

## 23.1.9 - 2026-03-16

* Update sinon to v21 [balena-renovate[bot]]

## 23.1.8 - 2026-03-13

* Convert most `forEach` functions to `for..of` [Pagan Gazzard]
...
* Add an application.getAllByOrganization() example with a $expand to the devices [Thodoris Greasidis]
* Fix application.create() example missing an organization parameter [Thodoris Greasidis]
* Fix application.getAllByOrganization() example missing an org parameter [Thodoris Greasidis]
...
* Switch lodash to a dev only dependency [Pagan Gazzard]

## 23.1.3 - 2026-03-11

* Unblock tests from node 24.14.0 fetch behavior changes [Thodoris Greasidis]

## 23.1.2 - 2026-03-11

* Remove abortcontroller-polyfill in favor of Node.js built-in AbortController [v1rtl]

## 23.1.1 - 2026-03-03

* Disable restriction on custom actions in workflow [Kyle Harding]
