...
getBillingModel = function(deps, opts) {
  var apiUrl, isBrowser, request;
  ...
  /**
  	 ...
  	 * });
   */
  exports.getBillingInfo = function(callback) {
    return request.send({
      method: 'GET',
  ...
  /**
  	 ...
  	 * });
   */
  exports.updateBillingInfo = function(billingInfo, callback) {
    return request.send({
      method: 'POST',
      url: '/user/billing/info',
      baseUrl: apiUrl,
  ...
  /**
  	 ...
  	 * });
   */
  exports.downloadInvoice = function(invoiceNumber, callback) {
    var url;
