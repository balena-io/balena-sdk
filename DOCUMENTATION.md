...
**Example**  
```js
balena.request.send({ url: 'http://api.balena.io/ping' });
```
...
balena.models.device.get(123).catch(function (error) {
  if (error.code === balena.errors.ResinDeviceNotFound.code) {
    ...
  } else if (error.code === balena.errors.ResinRequestError.code) {
    ...
  }
});
```
...
**Example**  
```js
balena.models.application.configVar.get('MyApp', 'RESIN_VAR').then(function(value) {
	console.log(value);
});
```
**Example**  
```js
balena.models.application.configVar.get(999999, 'RESIN_VAR').then(function(value) {
	console.log(value);
});
```
**Example**  
```js
balena.models.application.configVar.get('MyApp', 'RESIN_VAR', function(error, value) {
	if (error) throw error;
	console.log(value)
});
```
...
**Example**  
```js
balena.models.application.configVar.set('MyApp', 'RESIN_VAR', 'newvalue').then(function() {
	...
});
```
**Example**  
```js
balena.models.application.configVar.set(999999, 'RESIN_VAR', 'newvalue').then(function() {
	...
});
```
**Example**  
```js
balena.models.application.configVar.set('MyApp', 'RESIN_VAR', 'newvalue', function(error) {
	if (error) throw error;
	...
});
```
...
**Example**  
```js
balena.models.application.configVar.remove('MyApp', 'RESIN_VAR').then(function() {
	...
});
```
**Example**  
```js
balena.models.application.configVar.remove(999999, 'RESIN_VAR').then(function() {
	...
});
```
**Example**  
```js
balena.models.application.configVar.remove('MyApp', 'RESIN_VAR', function(error) {
	if (error) throw error;
	...
});
```
...
**Example**  
```js
balena.models.device.configVar.get('7cf02a6', 'RESIN_VAR').then(function(value) {
	console.log(value);
});
```
**Example**  
```js
balena.models.device.configVar.get(999999, 'RESIN_VAR').then(function(value) {
	console.log(value);
});
```
**Example**  
```js
balena.models.device.configVar.get('7cf02a6', 'RESIN_VAR', function(error, value) {
	if (error) throw error;
	console.log(value)
});
```
...
**Example**  
```js
balena.models.device.configVar.set('7cf02a6', 'RESIN_VAR', 'newvalue').then(function() {
	...
});
```
**Example**  
```js
balena.models.device.configVar.set(999999, 'RESIN_VAR', 'newvalue').then(function() {
	...
});
```
**Example**  
```js
balena.models.device.configVar.set('7cf02a6', 'RESIN_VAR', 'newvalue', function(error) {
	if (error) throw error;
	...
});
```
...
**Example**  
```js
balena.models.device.configVar.remove('7cf02a6', 'RESIN_VAR').then(function() {
	...
});
```
**Example**  
```js
balena.models.device.configVar.remove(999999, 'RESIN_VAR').then(function() {
	...
});
```
**Example**  
```js
balena.models.device.configVar.remove('7cf02a6', 'RESIN_VAR', function(error) {
	if (error) throw error;
	...
});
```
