...
<dl>
<dt><a href="#resin">resin</a> : <code>object</code></dt>
<dd><p>Welcome to the Resin SDK documentation.</p>
<p>This document aims to describe all the functions supported by the SDK, as well as showing examples of their expected usage.</p>
<p>If you feel something is missing, not clear or could be improved, please don&#39;t hesitate to open an <a href="https://github.com/resin-io/resin-sdk/issues/new">issue in GitHub</a>, we&#39;ll be happy to help.</p>
</dd>
</dl>
...
<dl>
<dt><a href="#getDashboardUrl">getDashboardUrl(options)</a> ⇒ <code>String</code></dt>
<dd></dd>
</dl>
...
* [resin](#resin) : <code>object</code>
    ...
    * [.models](#resin.models) : <code>object</code>
        ...
        * [.os](#resin.models.os) : <code>object</code>
            ...
            * [.getConfig(nameOrId)](#resin.models.os.getConfig) ⇒ <code>Promise</code>
...
##### os.getConfig(nameOrId) ⇒ <code>Promise</code>
**Kind**: static method of [<code>os</code>](#resin.models.os)  
...
```
<a name="getDashboardUrl"></a>

## getDashboardUrl(options) ⇒ <code>String</code>
